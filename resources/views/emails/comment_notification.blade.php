                                        ...
                                        <tr>
                                            <td align="center"
                                                ...
                                                <div
                                                    ...
                                                    Explore My Software Developer Portfolio</div>
                                            </td>
                                        </tr>
                                    </tbody>
                                </table>
                                                    ...
                                                    <tbody>
                                                        <tr>
                                                            <td style="width:176px;">
                                                                <img alt="" height="auto"
                                                                    src="https://i.ibb.co/18Stqmr/logo-dark.png"
                                        ...
                                        <tr>
                                            <td align="right"
                                                ...
                                                <div
                                                    ...
                                                    <a href="https://visitdominicazuka.com/"
                                                        style="color: #000000; text-decoration: none;">HOME</a>&nbsp;&nbsp;&nbsp;/&nbsp;&nbsp;&nbsp;<a
                                                        href="https://visitdominicazuka.com/services"
                                                        style="color: #000000; text-decoration: none;">SERVICES</a>&nbsp;&nbsp;&nbsp;/&nbsp;&nbsp;&nbsp;<a
                                                        href="https://visitdominicazuka.com/blog"
                                                        style="color: #000000; text-decoration: none;">BLOG</a></div>
                                            </td>
                                        </tr>
                                    </tbody>
                                </table>
                                    ...
                                    <tbody>
                                        <tr>
                                            <td align="center"
                                                ...
                                                <div
                                                    style="font-family:Montserrat, Helvetica, Arial, sans-serif;font-size:32px;font-weight:300;line-height:40px;text-align:center;color:#5FA91D;">
                                                    Unleash Innovation through Code: Elevate Your Experience!</div>
                                            </td>
                                        </tr>
                                    </tbody>
                                </table>
                                        ...
                                        <tr>
                                            <td align="center"
                                                ...
                                                <div
                                                    ...
                                                    Dive into a world of innovation, creativity, and cutting-edge
                                                    technology. Discover my software development journey and explore the
                                                    projects that showcase my skills and expertise.</div>
                                            </td>
                                        </tr>
                                    </tbody>
                                </table>
                            ...
                            <div class="mj-column-per-100 mj-outlook-group-fix"
                                ...
                                <table border="0" cellpadding="0" cellspacing="0" role="presentation"
                                    ...
                                    <tbody>
                                        ...
                                        <tr>
                                            <td align="center"
                                                style="font-size:0px;padding:50px 40px 40px 40px;word-break:break-word;">
                                                <div
                                                    ...
                                                    <p>Post Title: {{ $commentData['title'] }}</p>
                                                    <p>Name: {{ $commentData['name'] }}</p>
                                                    <p>Message: {{ $commentData['message'] }}</p>
                                                    <p>Kindly log in to your admin dashboard to view the comment.</p>
                                                </div>
                                            </td>
                                        </tr>
                                    </tbody>
                                            ...
                                            <td align="center"
                                                ...
                                                <table border="0" cellpadding="0" cellspacing="0"
                                                    ...
                                                    <tbody>
                                                        <tr>
                                                            <td style="width:600px;">
                                                                <img alt="bottom border" height="auto"
                                        ...
                                        <tr>
                                            <td align="center"
                                                ...
                                                <div
                                                    style="font-family:Montserrat, Helvetica, Arial, sans-serif;font-size:11px;font-weight:400;line-height:24px;text-align:center;color:#9B9B9B;">
                                                    <a href="https://visitdominicazuka.com"
                                                        style="color: #9B9B9B;">Unsubscribe</a> from this
                                                    newsletter<br />No. 4 Lemon Street, Mab Global, Gwarinpa,
                                                    Abuja<br /> <a href="#"
                                                        style="color: #9B9B9B; text-decoration:none;">Dominic Azuka</a>
                                                </div>
                                            </td>
                                        </tr>
                                    </tbody>
