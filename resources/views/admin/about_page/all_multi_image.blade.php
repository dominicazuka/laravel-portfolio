...
@section('admin')
@section('title', 'About Section Images - Admin | Dominic Azuka Portfolio')
                                ...
                                @foreach ($allMultiImage as $item)
                                    <tr>
                                        ...
                                        <td>
                                            ...
                                            <a href="{{ route('delete.multi.image',$item->id) }}" class="btn btn-danger sm ml-2" title="Delete Image" id="delete">
